...
ext_modules=[Extension("mkldnn._c_api", sources=['mkldnn/c_api.i'], swig_opts=swig_opts,
    ...
    extra_compile_args=ccxx_opts, libraries=['mkldnn']),
    Extension("mkldnn._relu_forward", sources=['mkldnn/relu_forward.i'], swig_opts=swig_opts,
    extra_compile_args=ccxx_opts, libraries=['mkldnn']),
    Extension("mkldnn._relu_backward", sources=['mkldnn/relu_backward.i'], swig_opts=swig_opts,
    extra_compile_args=ccxx_opts, libraries=['mkldnn']),
