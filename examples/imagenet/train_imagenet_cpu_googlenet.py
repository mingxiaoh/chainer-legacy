...
def main():
    ...
    # Set up an optimizer
    optimizer = chainer.optimizers.MomentumSGD(lr=0.012, momentum=0.9)
    optimizer.setup(model)
    optimizer.add_hook(chainer.optimizer.WeightDecay(0.0002))
    ...
    trainer.extend(extensions.poly.Poly('lr', (0.5, 800000)),
                   trigger=(1, 'iteration'))
