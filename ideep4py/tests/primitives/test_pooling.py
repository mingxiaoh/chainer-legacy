...
from ideep4py._ideep4py import poolingParam, pooling2D
...
pp.algo_kind = ideep4py._ideep4py.poolingParam.pooling_avg
...
pp.algo_kind = ideep4py._ideep4py.poolingParam.pooling_max
