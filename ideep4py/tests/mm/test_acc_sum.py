...
mx1 = ideep4py._ideep4py.mdarray(x1)
mx2 = ideep4py._ideep4py.mdarray(x2)
mx3 = ideep4py._ideep4py.mdarray(x3)
mx4 = ideep4py._ideep4py.mdarray(x4)

x = x1 + x2 + x3 + x4
mx = ideep4py._ideep4py.basic_acc_sum((mx1, mx2, mx3, mx4))
# mx = numpy.asarray(mx)
