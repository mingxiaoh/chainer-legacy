...
class LinearFunction(function_node.FunctionNode):
    ...
    def forward_ia(self, inputs):
        ...
        if lp.with_bias:
            (b, ) = ia.to_mdarray((b, ))
            y = ia.Linear_Py_F32.Forward(x, W, b, lp)
        else:
            y = ia.Linear_Py_F32.Forward(x, W, None, lp)
...
class LinearGradData(function_node.FunctionNode):
    ...
    def forward_ia(self, inputs):
        ...
        gx = ia.Linear_Py_F32.BackwardData(W, gy, lp)
        return gx,
...
class LinearGradWeight(function_node.FunctionNode):
    ...
    def forward_ia(self, inputs):
        ...
        (gW,) = ia.Linear_Py_F32.BackwardWeights(x, gy, lp)
        return gW,
